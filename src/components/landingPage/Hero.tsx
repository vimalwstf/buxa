...
//   return (
//     <div className="max-w-[1920px] mx-auto pt-[0rem] md:pt-[0rem]">
//       <section className="content-container space-x-6 mx-auto">
//         <div className="flex flex-col sm:text-start text-[9vw] px-[1%] mb-3">
//           <h1>The <span className="text-primary-green">Expert AI</span> Article</h1>
//           <div className="flex md:mt-[-30px]">
//             <h1> Writer</h1>
//             <div className="flex items-center justify-center gap-2 sm:gap-4">
//               <div>
//                 <Image className="h-[5vw] w-[5vw]" src={HeroGlobe} alt="Globe" />
//               </div>
//               <p className="text-[2vw] md:text-base w-[80%]">
//                 Your AI for tailored content, precise research, and
//                 SEO/SMO-optimized articles. Say goodbye to tedious tasks and
//                 hello to efficiency!
//               </p>
